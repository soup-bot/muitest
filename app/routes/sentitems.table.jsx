...
export function ErrorBoundary({}) {
    return (
        <main className='flex flex-col  align-middle items-center justify-center font-medium text-xl m-10'>
           ...
           <h4 className='text-red-800 flex flex-col md:flex-row align-middle justify-center items-center gap-3'><MdError size={25}/> There was an error retrieving your data</h4>
           </div>
        </main>
    );
  }
