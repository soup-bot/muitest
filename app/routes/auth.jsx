...
return(
    <div className='h-screen flex flex-col lg:flex-row '>
      ...
      <div className='text-2xl font-medium mt-8 text-gray-700'>Reach your customers with a simple click</div>
      </div>
...
<img className='h-screen w-screen object-fill bg-black' src={backdrop} alt="" />
        </div> 
